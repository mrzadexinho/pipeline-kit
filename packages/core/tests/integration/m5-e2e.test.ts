...
describe('M5 E1 — LocalTriggerAdapter + HMAC idempotency + allowlist redaction', () => {
  ...
  it('all five hard-gate assertions pass', async () => {
    ...
    expect(handlerInvokedCount, 'Assertion 2 — cron fired at least once').toBeGreaterThanOrEqual(1);
