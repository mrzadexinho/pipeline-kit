// Cat VIII spike #4 — shared mock SecretsResolver fixture.
// Forked VERBATIM from spike #3 (factory-and-runtime/mock-secrets-resolver.ts).
// The version-aware behaviour lives in the WRAPPER, not the underlying mock —
// the mock stays bit-identical so spike #2 / #3 / #4 read counts are
// directly comparable.
//
...
// across the rotation and two-site harnesses.
...
// per-cell comparisons across spike-#4 cells.
...
// honest). Exported for backward-compat with spike-#1/#2/#3-shaped imports.
