// Cat VIII spike #4 — mock Apify HTTP client.
// Forked VERBATIM from spike #3 (factory-and-runtime/mock-apify-http-client.ts).
// Reused as-is for the two-site harness so spike-#3 vs spike-#4 traces are
// directly comparable.
//
