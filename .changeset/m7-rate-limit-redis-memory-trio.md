---
'@idriszade/rate-limit-redis': minor
'@idriszade/memory-map': minor
'@idriszade/memory-orchestr8': minor
'@idriszade/memory-sqlite': minor
'@idriszade/core': patch
---

M7: rate-limit-redis distributed adapter; V-6 memory trio (map/orchestr8/sqlite); composer-internals refactor; Trusted Publishing.
